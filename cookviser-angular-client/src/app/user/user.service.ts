...
export class UserService {
  ...
  public fetchAll(): Observable<HttpResponse<IUserCard[]>> {
    // return observableOf(this.users);
    return this.http.get<HttpResponse<IUserCard[]>>(`${this.host}/getAll`);
  }

  public fetchBestThreeChefs(): Observable<HttpResponse<IUserCard[]>> {
    // return observableOf(this.users.slice(0, 3));
    return this.http.get<HttpResponse<IUserCard[]>>(`${this.host}/bestThree`);
  }
}
